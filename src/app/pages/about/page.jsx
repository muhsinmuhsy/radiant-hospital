...
import { Heart, Stethoscope, Microscope, UserCircle, Phone, Mail, MapPin, Clock, Award, Target, Star, Shield, BookOpen, Users } from 'lucide-react';
        ...
        <div className="lg:flex lg:items-center lg:gap-12">
          <div className="lg:w-1/2 text-white mb-20 lg:mb-0">
            <h1 className="text-5xl lg:text-6xl font-bold leading-tight mb-6">
              Excellence in<br />ENT Care
            </h1>
            <p className="text-xl leading-relaxed mb-8">
              Leading the way in comprehensive ear, nose, and throat treatments with cutting-edge 
        ...
        <div className="grid md:grid-cols-2 gap-12">
          <div className="bg-white rounded-xl p-8 shadow-xl transform hover:-translate-y-2 transition-transform duration-300 relative overflow-hidden">
            ...
            <p className="text-gray-600 leading-relaxed mb-6">
              To provide world-class ENT care through innovative treatments, compassionate service, 
              and a patient-first approach that enhances the quality of life for every individual 
              we serve.
            </p>
          ...
          <div className="bg-white rounded-xl p-8 shadow-xl transform hover:-translate-y-2 transition-transform duration-300 relative overflow-hidden">
            ...
            <p className="text-gray-600 leading-relaxed mb-6">
              To be the leading ENT care provider, recognized globally for excellence in patient care, 
              medical innovation, and outstanding clinical outcomes, while fostering a healing 
              environment that benefits patients and healthcare providers alike.
            </p>
            <ul className="space-y-3 text-gray-600">
              <li className="flex items-center">
                <div className="w-2 h-2 bg-[#11B3B8] rounded-full mr-3" />
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
          {values.map((value, index) => (
            <div key={index} className="bg-white/90 backdrop-blur rounded-xl p-6 text-center shadow-xl">
              <div className="text-[#11B3B8] font-medium">{value}</div>
            </div>
          ))}
        </div>
      </div>
        ...
        <div className="bg-white rounded-xl p-8 lg:p-12 shadow-xl">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-800">info@entexcellence.com</p>
            </div>
            <div className="text-center">
              <MapPin size={24} className="mx-auto mb-4 text-[#11B3B8]" />
              <p className="text-gray-800">123 Medical Center Drive<br />City, State 12345</p>
            </div>
            <div className="text-center">
              <Clock size={24} className="mx-auto mb-4 text-[#11B3B8]" />
              <p className="text-gray-800">Mon-Fri: 8am - 6pm<br />Sat: 9am - 2pm</p>
            </div>
          </div>
        </div>
      </div>
