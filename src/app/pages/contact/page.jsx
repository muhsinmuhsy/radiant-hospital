...
const AboutUs = () => {
  ...
  const values = [
    { id: 'excellence', icon: <Star size={24} />, title: 'Medical Excellence', 
      desc: 'Committed to providing the highest standard of ENT care' },
    { id: 'innovation', icon: <Award size={24} />, title: 'Innovation', 
      desc: 'Using cutting-edge technology and latest medical advances' },
    { id: 'compassion', icon: <Heart size={24} />, title: 'Patient-First Care', 
      desc: 'Treating every patient with empathy and personalized attention' }
  ];
    ...
    <div className="min-h-screen">
        ...
        <div className="relative z-20 h-full flex items-center">
          <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h1 className="text-3xl xs:text-4xl sm:text-5xl md:text-6xl font-bold text-white mb-3 sm:mb-4 md:mb-6">
              Welcome to<br />
              <span className="block mt-2" style={{ color: '#76f7fb' }}>Radiant Hospital</span>
            </h1>
            <p className="text-base xs:text-lg sm:text-xl text-gray-200 max-w-2xl mb-16 sm:mb-20">
              Pioneering ENT care in Kannur with advanced technology and 
              compassionate healing for over two decades.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white shadow-lg relative -mt-16 sm:-mt-20 z-30 mx-3 xs:mx-4 sm:mx-8 lg:mx-auto max-w-6xl rounded-xl">
        <div className="grid grid-cols-1 xs:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6 p-4 sm:p-6 md:p-8">
          {[
            { icon: <Phone />, title: "Contact", info: "+91 123 456 7890" },
            { icon: <Clock />, title: "Hours", info: "24/7 Emergency Care" },
            { icon: <MapPin />, title: "Location", info: "Kannur, Kerala" }
          ].map((item, i) => (
