...
const SpecialtyDetails = () => {
  ...
  return (
   ...
   <div className="min-h-screen bg-gray-50">
      ...
      {/* Hero Section */}
      <div className="text-white" style={{ background: 'linear-gradient(132.55deg, #8B489A 15.07%, #795F9F 95.26%)' }}>
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid md:grid-cols-3 gap-8">
                ...
                <div className="space-y-3">
                  {specialty?.benefits?.map((benefit, index) => (
                    <div key={index} className="flex items-center gap-3">
                      <CheckCircle className="w-5 h-5" style={{ color: '#8B489A' }} />
          ...
          {/* Consultation Card */}
          <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-lg shadow-lg h-fit" style={{ background: 'linear-gradient(to bottom right, #D4BEDE, #f9f5fb)' }}>
            <div className="p-6">
              ...
              <div className="w-full text-white rounded-lg hover:opacity-90 transition-colors flex items-center justify-center gap-2 group" style={{ backgroundColor: '#795F9F' }}>
                <AppointmentBooking />
